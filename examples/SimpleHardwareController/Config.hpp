...
TurnSteeringCarConfig config = {
    ...
    {8, 9, 10},   // rearRight
    // Rot
    //{52, 40, 40, 47, 73, 98}, // steering Rot
    // Blau
    {52, 40, 39, 29, 66, 102}, // steering Blau
    120,
    100,      // width, length
    204,      // wheel circumfrence
    {48, 49}, // frontDistance
    {46, 47}, // rearDistance
    nullptr,  // const_cast<int16_t *>(rpmLut)
};

uint8_t brightnessPins[3] = {A0, A1, A2};
// Blau
BrightnessThresholds thresholds[3] = {{48, 158},
                                      {66, 205},
                                      {45, 133}};


// Rot:
/*BrightnessThresholds thresholds[3] = {{44, 131},
{45, 133},
{52, 135}};*/
