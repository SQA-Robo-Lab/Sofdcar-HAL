...
#include "src/lineDetector/brightnessSensor/BrightnessSensorDigital.hpp"
...
MotorDcHBridge rearLeft(MOTOR_SPEED_UNIT_RPM, 6, 8, 9);
MotorDcHBridge rearRight(MOTOR_SPEED_UNIT_RPM, 11, 12, 13);
...
BrightnessSensorDigital sensor(pins, 3, true, true);

LinearSensorLineDetector ld(sensor, 20);
...
void loop()
{
    ...
    Serial.print(ld.getLinePositionMm());
    Serial.print("mm; Legacy: ");
    Serial.println(ld.getLegacyPosition());
    delay(50);
}